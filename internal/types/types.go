...
// Using a distinct type (not alias) provides compile-time type checking
// and prevents accidental assignment from other map types.
type Metadata map[string]any

// SupportingEvidenceMap is a distinct type for evidence data.
type SupportingEvidenceMap map[string]any

// ValidationDataMap is a distinct type for validation data.
type ValidationDataMap map[string]any
...
type Insight struct {
	...
	SupportingEvidence Metadata      `json:"supporting_evidence"`
...
type Validation struct {
	...
	ValidationData Metadata  `json:"validation_data,omitempty"`
...
type ResponseMetadata struct {
	...
	ExportFormats Metadata `json:"export_formats,omitempty"`
}
