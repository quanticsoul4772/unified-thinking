...
A Model Context Protocol (MCP) server that consolidates multiple cognitive thinking patterns into a single Go-based implementation with 75 specialized reasoning tools.
...
| Decision | 3 | Multi-criteria analysis, problem decomposition |
| Metacognition | 3 | Self-evaluation, bias detection, blind spots |
| Hallucination | 4 | Verification, calibration tracking |
...
**Test Coverage:** 78.3% overall | 135 test files | 100% pass rate
...
| reasoning | 94.8% |
| memory, modes | 90%+ |
| analysis, validation, storage | 87%+ |
