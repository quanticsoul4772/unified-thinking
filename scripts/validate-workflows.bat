...
go mod download
if errorlevel 1 (
    echo ✗ FAIL: Download dependencies
    set /a FAILURES+=1
) else (
...
if errorlevel 1 (
    echo ✗ FAIL: Tests with race detector
    set /a FAILURES+=1
) else (
    echo ✓ PASS: Tests with race detector
)
echo.
